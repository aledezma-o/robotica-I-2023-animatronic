...
Servo myservo;  // Crear objeto del servo

void setup() {
  myservo.attach(9);  // Asignar pin 9 para controlar el servo
}

void loop() {
  // Leer valor de ángulo desde el puerto serie
  if (Serial.available()) {
...
en mi raspbery en programando en python:
